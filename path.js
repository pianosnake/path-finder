PATH = function(){
    var context,canvas,startPt,endPt,image,imageData,btn,width,height; 
    ...
    return {
        init: function(config){
            ...
            btn = document.getElementById("findPathBtn");
            var removePathsBtn = document.getElementById("removePathsBtn");
            ...
            btn.addEventListener("click",checkInputs,false); 
            removePathsBtn.addEventListener("click",resetMap,false); 
        }
    }
