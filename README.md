This app tries to find the easiest hike from one point to another in a landscape. It's a JavaScript implementation using HTML5 canvas and A* with binary heaps to find the easiest path.
